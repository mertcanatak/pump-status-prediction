...
class LSTMPipeline:
    def __init__(self, data_path, model_path="https://raw.githubusercontent.com/mertcanatak/water-pump-status-prediction/main/lstm_model.keras"):
    ...
    def load_data(self):
        """Veriyi dosyadan okur ve DataFrame olarak kaydeder."""
        self.df = pd.read_csv(self.data_path)

    def preprocess_data(self):
        """Veriyi işleyerek model için hazır hale getirir."""
    ...
    def split_data(self):
        """Veriyi eğitim, test ve M_test setlerine böler."""
    ...
    def load_model(self):
        """Kaydedilmiş modeli belirtilen dosya yolundan yükler."""
        self.model = load_model(self.model_path)

    def evaluate_model(self, X_test, y_test, X_M_test, y_M_test):
        """Modeli test ve M_test setlerinde değerlendirir ve sonuçları döndürür."""
...
pipeline = LSTMPipeline("pythonProject/sensor.csv")
pipeline.load_data()
...
print(f"Test Set Accuracy (Loaded Model): {test_accuracy:.4f}")
print(f"M_test Set Accuracy (Loaded Model): {M_test_accuracy:.4f}")
